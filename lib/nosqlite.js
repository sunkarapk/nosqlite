...
(function() {
  ...
  nosqlite.Connection.prototype.database = function(name, modem, idName) {
    var that;
    that = this;
    return {
      ...
      post: function(obj, cb) {
        ...
        return this._write(obj[idName], JSON.stringify(obj, null, 2), function(err) {
          if (err) {
            return cb(err);
          } else {
            return cb(null, obj[idName]);
          }
        });
      },
      postSync: function(obj) {
        ...
        this._writeSync(obj[idName], JSON.stringify(obj, null, 2));
        return obj[idName];
      },
